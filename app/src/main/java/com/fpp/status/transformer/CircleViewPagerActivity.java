...
//    }
    ...
    private static class MyHandler extends Handler {
        private WeakReference<CircleViewPagerActivity> mWeakReference;

        public MyHandler(CircleViewPagerActivity activity) {
            mWeakReference = new WeakReference<CircleViewPagerActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    CircleViewPagerActivity activity = mWeakReference.get();
