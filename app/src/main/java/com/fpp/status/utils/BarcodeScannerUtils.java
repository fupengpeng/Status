...
public class BarcodeScannerUtils {
    ...
    private static volatile BarcodeScannerUtils mInstance;
    ...
    public static BarcodeScannerUtils getInstance() {
        if (null == mInstance) {
            synchronized (BarcodeScannerUtils.class) {
                if (null == mInstance) {
                    mInstance = new BarcodeScannerUtils();
                }
            }
        }
        return mInstance;
