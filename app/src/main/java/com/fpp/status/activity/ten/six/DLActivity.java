...
import com.fpp.status.view.download.DUtil;
...
public class DLActivity  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dll);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.single_task:
                startActivity(new Intent(this, TenSixActivity.class));
                break;
        ...
        DUtil.initFormUpload()
                ...
                .upload(new UploadCallback() {
                    ...
                    public void onFinish(String response) {
                        ...
                        Toast.makeText(DLActivity.this, "finish", Toast.LENGTH_SHORT).show();
                    }
