...
public class UsbCameraActivity extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    public static final String TAG = UsbCameraActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        LogUtil.getInstance(UsbCameraActivity.this).start();
        initView();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_takepic:
                ...
                String imgName = "IMG_" + DateTimeUtil.getDateTime("yyyyMMdd_hhmmss");
                String picPath = BaseApplication.PATH_DIR + File.separator + "images" + File.separator
                        + imgName + UVCCameraHelper.SUFFIX_JPEG;
            ...
            case R.id.menu_recording:
                ...
                if (!mCameraHelper.isPushing()) {
                    String videoName = "VIDEO_" + DateTimeUtil.getDateTime("yyyyMMdd_hhmmss");
                    String videoPath = BaseApplication.PATH_DIR + File.separator + "videos" + File.separator
                            + videoName
//                            + UVCCameraHelper.SUFFIX_MP4
                            ;

                    FileUtils.createfile(BaseApplication.PATH_DIR + File.separator + "videos" + File.separator
                            + videoName + ".h264");
                    // if you want to record,please create RecordParams like this
                    RecordParams params = new RecordParams();
                    params.setRecordPath(videoPath);
                    params.setRecordDuration(0);                        // auto divide saved,default 0 means not divided
                    LogUtil.e("voice = " + mSwitchVoice.isChecked());
