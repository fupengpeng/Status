...
public class CVV   extends SurfaceView
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(CVV.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(CVV.class.getName());
        }
    }
    ...
    public void setMediaController(CMC controller) {
...
//                    }
    ...
    private void enableOrientationDetect() {
        if (mAutoRotation && mOrientationDetector == null) {
            ...
            mOrientationDetector.setOrientationChangeListener(CVV.this);
    ...
    public void finishActivity() {
        videoViewCallback.finishActivity();
    }
...
*/
    ...
    public void setVideoViewCallback(VVC callback) {
