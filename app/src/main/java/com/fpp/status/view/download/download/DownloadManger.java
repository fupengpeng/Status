...
public class DownloadManger {
    ...
    public DownloadData getDbData(String url) {
        return BaseApplication.daoSession.getDownloadDataDao().queryBuilder()
    ...
    public List<DownloadData> getAllDbData() {
        return BaseApplication.daoSession.getDownloadDataDao()
                .queryBuilder().list();
    }
    ...
    private synchronized void execute(DownloadData downloadData, DownloadCallback downloadCallback) {
        ...
        if (ThreadPool.getInstance().getThreadPoolExecutor().getActiveCount()
    ...
    public void resume(String url) {
        // 判断任务进度处理对象存在，且下载状态是暂停或者错误,则移除此任务进度处理对象，重新开始一个任务。
        //                   不存在，                         则重新开始一个任务。
        if (progressHandlerMap.containsKey(url) &&
    ...
    public Map<String, DownloadProgressHandler> getProgressHandlerMap() {
        return progressHandlerMap;
    }

    public void setProgressHandlerMap(Map<String, DownloadProgressHandler> progressHandlerMap) {
        this.progressHandlerMap = progressHandlerMap;
    }

    public Map<String, DownloadData> getDownloadDataMap() {
        return downloadDataMap;
    }

    public void setDownloadDataMap(Map<String, DownloadData> downloadDataMap) {
    ...
    public void setCallbackMap(Map<String, DownloadCallback> callbackMap) {
        this.callbackMap = callbackMap;
    }

    public Map<String, FileTask> getFileTaskMap() {
        return fileTaskMap;
    }

    public void setFileTaskMap(Map<String, FileTask> fileTaskMap) {
