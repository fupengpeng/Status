...
public class HAFObserver<T extends HAFAdapter> extends RecyclerView.AdapterDataObserver {
    ...
    public HAFObserver(RecyclerView mRecyclerView, View mEmptyView, RecyclerView.Adapter mRealAdapter, T mAdapter, boolean showEmptyViewHasHF) {
    ...
    protected int getItemCount() {
        ...
        if (!showEmptyViewHasHF) {
            if (mAdapter instanceof HAFAdapter)
