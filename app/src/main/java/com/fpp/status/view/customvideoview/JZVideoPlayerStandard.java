...
public class JZVideoPlayerStandard extends JZVideoPlayer {
    ...
    public void changeStartButtonSize(int size) {
        LogUtil.e("changeStartButtonSize");
    ...
    public void onStatePreparingChangingUrl(int urlMapIndex, long seekToInAdvance) {
        ...
        LogUtil.e("onStatePreparingChangingUrl");
        ...
        if (id == R.id.surface_container) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    LogUtil.e("onTouch  "  +"  surface_container  "   + "  ACTION_DOWN" );
                    break;
                case MotionEvent.ACTION_MOVE:
                    LogUtil.e("onTouch  "  +"  surface_container  "   + "  ACTION_MOVE" );
                    break;
                case MotionEvent.ACTION_UP:
                    LogUtil.e("onTouch  "  +"  surface_container  "   + "  ACTION_UP" );
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    LogUtil.e("onTouch  "  +"  bottom_seek_progress  "   + "  ACTION_DOWN" );
                    cancelDismissControlViewTimer();
                    break;
                case MotionEvent.ACTION_UP:
                    LogUtil.e("onTouch  "  +"  bottom_seek_progress  "   + "  ACTION_UP" );
                    startDismissControlViewTimer();
                    break;
            }
        }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            // 全屏点击事件
            LogUtil.e("onClick  "  +"  surface_container  "   + "" );
            startDismissControlViewTimer();
        } else if (i == R.id.back) {
            // 返回事件
            LogUtil.e("onClick  "  +"  back  "   + "" );
            backPress();
        } else if (i == R.id.back_tiny) {
            LogUtil.e("onClick  "  +"  back_tiny  "   + "" );
    ...
    public void setSystemTimeAndBattery() {
        LogUtil.e("setSystemTimeAndBattery"+"");
    ...
    public void onCLickUiToggleToClear() {
        LogUtil.e("onCLickUiToggleToClear"+"");
        if (currentState == CURRENT_STATE_PREPARING) {
            if (bottomContainer.getVisibility() == View.VISIBLE) {
                changeUiToPreparing();
            } else {
...
//        LogUtil.e("setProgressAndText"+"");
    ...
    public void resetProgressAndTime() {
        LogUtil.e("resetProgressAndTime"+"");
    ...
    public void changeUiToPauseClear() {
        LogUtil.e("changeUiToPauseClear"+"");
        switch (currentScreen) {
            case SCREEN_WINDOW_NORMAL:
            case SCREEN_WINDOW_LIST:
                setAllControlsVisiblity(View.INVISIBLE, View.INVISIBLE, View.INVISIBLE,
    ...
    public void setAllControlsVisiblity(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        LogUtil.e("setAllControlsVisiblity"+"");
    ...
    public void dismissProgressDialog() {
        LogUtil.e("dismissProgressDialog"+"");
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        LogUtil.e("showBrightnessDialog"+"");
    ...
    public void dismissBrightnessDialog() {
        LogUtil.e("dismissBrightnessDialog"+"");
    ...
    /**
     * 创建弹窗（快进、快退、音量大小改变、亮度改变等）
     * @param localView
     * @return
     */
    public Dialog createDialogWithView(View localView) {
        LogUtil.e("createDialogWithView"+"");
    ...
    public void startDismissControlViewTimer() {
        LogUtil.e("startDismissControlViewTimer"+"");
        cancelDismissControlViewTimer();
    ...
    public void cancelDismissControlViewTimer() {
        LogUtil.e("cancelDismissControlViewTimer"+"");
    ...
    /**
     * 计时器，标题栏、播放进度栏显示后，指定时间后隐藏
     */
    public class DismissControlViewTimerTask extends TimerTask {

        @Override
        public void run() {
            LogUtil.e("DismissControlViewTimerTask  "+"run");
            dissmissControlView();
        }
    }
}
