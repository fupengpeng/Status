...
public abstract class JZVideoPlayer
        ...
        public void onAudioFocusChange(int focusChange) {
            switch (focusChange) {
                ...
                case AudioManager.AUDIOFOCUS_LOSS:
                    releaseAllVideos();
                    LogUtil.d(TAG, "AUDIOFOCUS_LOSS [" + this.hashCode() + "]");
                    break;
                case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT:
                    ...
                    LogUtil.d(TAG, "AUDIOFOCUS_LOSS_TRANSIENT [" + this.hashCode() + "]");
                    break;
    ...
    public static void releaseAllVideos() {
        if ((System.currentTimeMillis() - CLICK_QUIT_FULLSCREEN_TIME) > FULL_SCREEN_NORMAL_DELAY) {
            LogUtil.d(TAG, "releaseAllVideos");
...
//                JZVideoPlayer.releaseAllVideos();
            ...
            if ((currentPlayPosition < firstVisibleItem || currentPlayPosition > (lastVisibleItem - 1))) {
                if (JZVideoPlayerManager.getCurrentJzvd() != null &&
                    ...
                    if (JZVideoPlayerManager.getCurrentJzvd().currentState == JZVideoPlayer.CURRENT_STATE_PAUSE) {
                        ...
                        LogUtil.e(TAG, "onScroll: out screen");
                ...
                if (JZVideoPlayerManager.getCurrentJzvd() != null &&
                        JZVideoPlayerManager.getCurrentJzvd().currentScreen == JZVideoPlayer.SCREEN_WINDOW_TINY) {
                    LogUtil.e(TAG, "onScroll: into screen");
    ...
    public static void onScrollReleaseAllVideos(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        int lastVisibleItem = firstVisibleItem + visibleItemCount;
        int currentPlayPosition = JZMediaManager.instance().positionInList;
        LogUtil.e(TAG, "onScrollReleaseAllVideos: " +
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.start) {
            ...
            if (currentState == CURRENT_STATE_NORMAL) {
                ...
                LogUtil.d(TAG, "pauseVideo [" + this.hashCode() + "] ");
                JZMediaManager.pause();
                onStatePause();
            ...
            if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
                ...
                LogUtil.d(TAG, "toFullscreenActivity [" + this.hashCode() + "] ");
...
//                        mDownY = y;
    ...
    public void startVideo() {
        JZVideoPlayerManager.completeAll();
        LogUtil.d(TAG, "startVideo [" + this.hashCode() + "] ");
        initTextureView();
        addTextureView();
    ...
    public void onError(int what, int extra) {
        LogUtil.e(TAG, "onError " + what + " - " + extra + " [" + this.hashCode() + "] ");
    ...
    public void release() {
        if (JZUtils.getCurrentFromDataSource(dataSourceObjects, currentUrlMapIndex).equals(JZMediaManager.getCurrentDataSource()) &&
            ...
            if (JZVideoPlayerManager.getSecondFloor() != null &&
                ...
                LogUtil.d(TAG, "releaseMediaPlayer [" + this.hashCode() + "]");
                releaseAllVideos();
            }
        }
    }
...
//        LogUtil.d(TAG, "setProgressAndText: progress=" + progress + " position=" + position + " duration=" + duration);
